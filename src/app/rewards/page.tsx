...
export default function RewardsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col justify-between h-full border-l-4 border-red-500 mb-8">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">Reward Balance</h2>
        <div className="flex items-center justify-between mt-auto">
          <div className="flex items-center">
            <Coins className="w-10 h-10 mr-3 text-red-500" />
            <div>
              <span className="text-4xl font-bold text-red-500">{balance}</span>
            ...
            {transactions.length > 0 ? (
              transactions.map(transaction => (
                <div key={transaction.id} className="flex items-center justify-between p-4 border-b border-gray-200 last:border-b-0">
                  ...
                  <span className={`font-semibold ${transaction.type.startsWith('earned') ? 'text-red-500' : 'text-red-500'}`}>
              ...
              rewards.map(reward => (
                <div key={reward.id} className="bg-white p-4 rounded-xl shadow-md">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-red-500 font-semibold">{reward.cost} points</span>
                  </div>
