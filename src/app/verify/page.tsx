  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md mb-8">
        ...
        <Button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white" disabled={!file || verificationStatus === 'verifying'}>
      ...
      {verificationStatus === 'success' && verificationResult && (
        <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-8">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">Verification Successful</h3>
